 ...
 */
/* Compiler settings for C:\Users\tonuv\AppData\Local\Temp\AudioAnalyzer.idl-bfad4746:
...
#define __x_ABI_CAudioAnalyzer_CIVisualizationSource_GetFrame(This,result)	\
    ( (This)->lpVtbl -> GetFrame(This,result) ) 

#define __x_ABI_CAudioAnalyzer_CIVisualizationSource_SetLinearFScale(This,outputElements)	\
    ( (This)->lpVtbl -> SetLinearFScale(This,outputElements) ) 

#define __x_ABI_CAudioAnalyzer_CIVisualizationSource_SetLogFScale(This,lowFrequency,highFrequency,numberOfBins)	\
    ( (This)->lpVtbl -> SetLogFScale(This,lowFrequency,highFrequency,numberOfBins) ) 

#define __x_ABI_CAudioAnalyzer_CIVisualizationSource_get_FrequencyStep(This,result)	\
    ( (This)->lpVtbl -> get_FrequencyStep(This,result) ) 

#define __x_ABI_CAudioAnalyzer_CIVisualizationSource_get_IsLogFrequencyScale(This,result)	\
    ( (This)->lpVtbl -> get_IsLogFrequencyScale(This,result) ) 

#define __x_ABI_CAudioAnalyzer_CIVisualizationSource_get_LowFrequency(This,result)	\
    ( (This)->lpVtbl -> get_LowFrequency(This,result) ) 

#define __x_ABI_CAudioAnalyzer_CIVisualizationSource_get_HighFrequency(This,result)	\
    ( (This)->lpVtbl -> get_HighFrequency(This,result) ) 

#define __x_ABI_CAudioAnalyzer_CIVisualizationSource_get_OutputElementsCount(This,result)	\
    ( (This)->lpVtbl -> get_OutputElementsCount(This,result) ) 

#define __x_ABI_CAudioAnalyzer_CIVisualizationSource_get_IsLogAmplitudeScale(This,result)	\
    ( (This)->lpVtbl -> get_IsLogAmplitudeScale(This,result) ) 

#define __x_ABI_CAudioAnalyzer_CIVisualizationSource_put_IsLogAmplitudeScale(This,value)	\
