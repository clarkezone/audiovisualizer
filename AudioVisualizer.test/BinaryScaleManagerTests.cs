...
namespace AudioVisualizer.test
{
    ...
    public class BinaryScaleManagerTests
    {
        ...
        public void BinaryScaleManager_GetRange_0_5()
        {
            ...
            Assert.AreEqual(new ContentScaleRange() { From = .5, To = 1.0 }, range);
        }
        [TestMethod()]
        [TestCategory("ScaleManager")]
        public void BinaryScaleManager_GetRange_2()
        {
            ...
            Assert.AreEqual(new ContentScaleRange() { From = 2.0, To = 4.0 },range);
        }
        [TestMethod()]
        [TestCategory("ScaleManager")]
        ...
        public void BinaryScaleManager_GetRange_4()
        {
            ...
            Assert.AreEqual(new ContentScaleRange() { From = 4.0, To = 8.0 }, range);
        }
    }
    ...
    public class BinaryScaleManagerWithStepTests
    {
        ...
        public void BinaryScaleManagerWS_GetRange_1()
        {
            ...
            Assert.AreEqual(new ContentScaleRange() { From = 0.25, To = 2.0 }, range);
        }
        ...
        {
            var range = sut.GetRange(2.0);
            Assert.AreEqual(new ContentScaleRange() { From = 2.0, To = 16.0 }, range);
        }
        ...
        public void BinaryScaleManagerWS_GetRange_16()
        {
            ...
            Assert.AreEqual(new ContentScaleRange() { From = 16.0, To = 128.0 }, range);
        }
    }
